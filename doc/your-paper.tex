...
\title{Probing Chest X-ray Representations in MedGemma}
\date{}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/mean_auroc_over_layers.png}
    \caption{
...
\begin{table}[t]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_mean.tex}}
\end{table}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/atelectasis_auroc_over_layers.png}
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_atelectasis.tex}}
\end{table}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/cardiomegaly_auroc_over_layers.png}
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_cardiomegaly.tex}}
\end{table}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/consolidation_auroc_over_layers.png}
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_consolidation.tex}}
\end{table}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/edema_auroc_over_layers.png}
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_edema.tex}}
\end{table}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/plots/pleural_effusion_auroc_over_layers.png}
...
\begin{table}[!htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../artifacts/tables/representation_pleural_effusion.tex}}
\end{table}
